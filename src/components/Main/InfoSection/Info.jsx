...
const Info = () => {
    return (
        <div className="flex items-center py-12 flex-col bg-contentBackground bg-no-repeat bg-center">   
            ...
            <LazyShow>
            <h1 className="text-4xl text-gray-200 font-Fredoka tracking-wider border-b-2 border-darkGray mb-7">A little bit about us</h1>
                <p className="text-gray-200 text-xl tracking-wide mb-auto font-Quicksand">
            ...
            <LazyShow>
            <h1 className="text-4xl text-gray-200 font-Fredoka tracking-wider border-b-2 border-darkGray mb-7">Have some fun.</h1>
                <p className="text-gray-200 text-xl tracking-wide mb-auto font-Quicksand">
            ...
            <LazyShow>
            <h1 className="text-4xl text-gray-200 font-Fredoka tracking-wider border-b-2 border-darkGray mb-7">The Goal.</h1>
                <p className="text-gray-200 text-xl tracking-wide mb-auto font-Quicksand">
