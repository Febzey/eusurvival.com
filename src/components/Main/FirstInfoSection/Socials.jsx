...
const Socials = () => {
    return (
        <div className="flex flex-col items-center justify-center">
            <h1 className="font-bold text-xl text-neutral-200 mr-auto ml-auto mb-2 font-Quicksand">Check out our socials</h1>
            <div className="flex flex-row text-white text-5xl gap-3 flex-wrap">
